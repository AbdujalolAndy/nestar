...
export class FollowService {
    ...
    public async subscribe(followerId: ObjectId, followingId: ObjectId): Promise<Follower> {
        ...
        const result = await this.registerSubscribe(followerId, followingId);
    ...
    private async registerSubscribe(followerId: ObjectId, followingId: ObjectId): Promise<Follower> {
        try {
    ...
    async getMemberFollowings(memberId: ObjectId, input: FollowInquiry): Promise<Followings> {
